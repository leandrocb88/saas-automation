            ...
            <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-bold text-gray-900 dark:text-white">YouTube Summarizer</span>
                        </Link>
                        <p className="mt-4 text-sm text-gray-500 dark:text-gray-400">
                            Turn hours of content into minutes of reading. AI-powered summaries for modern creators and consumers.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="mt-4 space-y-3">
                            <li>
                                <Link href={route('youtube.home')} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                    Analyzer
                                </Link>
                            </li>
                            <li>
                                <Link href={route('plans')} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                    Pricing
                                </Link>
                            </li>
                            <li>
                                <Link href={route('youtube.channel')} className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                    Channels
                                </Link>
                            </li>
                        </ul>
                ...
                <div className="mt-12 border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <p className="text-sm text-gray-400 dark:text-gray-500">
                        &copy; {currentYear} YouTube Summarizer. All rights reserved.
                    </p>
