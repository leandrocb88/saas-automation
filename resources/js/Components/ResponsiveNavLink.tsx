    ...
    return (
        <Link
            ...
            className={`flex w-full items-start border-l-4 py-2 pe-4 ps-3 ${active
                    ...
                    : 'border-transparent text-gray-600 hover:border-gray-300 hover:bg-gray-100 hover:text-black focus:border-gray-300 focus:bg-gray-50 focus:text-gray-800 dark:text-gray-400 dark:hover:border-gray-500 dark:hover:bg-gray-800 dark:hover:text-white dark:focus:border-gray-600 dark:focus:bg-gray-700 dark:focus:text-gray-200'
