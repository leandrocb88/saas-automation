                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            <div className="bg-white dark:bg-gray-800 rounded-2xl ring-1 ring-gray-300 dark:ring-gray-700/50 shadow-sm overflow-hidden flex flex-col h-[1000px]">
                                {/* Video Player Box */}
                                <div className="bg-black flex-shrink-0 w-full border-b border-gray-200 dark:border-gray-700/50">
                                    <YouTubePlayer ref={playerRef} videoUrl={videoUrl} />
                                </div>
                                <div className="px-5 py-3 border-b border-gray-200 dark:border-gray-600 flex justify-between items-center shrink-0">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div key={index} className="mb-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 p-2.5 rounded-lg transition-colors group">
                                            {includeTimestamps && (
                                                <button 
                                                    ...
                                                    className="text-xs font-mono text-indigo-600 dark:text-indigo-400 font-semibold mb-1 hover:text-indigo-800 dark:hover:text-indigo-300 transition-colors text-left flex items-center gap-1"
                                                >
