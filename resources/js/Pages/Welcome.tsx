                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end items-center">
                                {auth.user ? (
                                    ...
                                    <>
                                        {auth.guest && (
                                            <div className="hidden sm:flex items-center gap-2 mr-4 px-3 py-1.5 rounded-full border border-gray-200 dark:border-gray-700 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm shadow-sm">
                                                <span className="h-2 w-2 rounded-full bg-green-500 animate-pulse"></span>
                                                <span className="text-xs font-bold text-gray-700 dark:text-gray-300">
                                                    {auth.guest.quota.remaining} Free Credits
                                                </span>
                                            </div>
                                        )}
                                        <Link
                        ...
                        <div className="text-center py-16 lg:py-24">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                                AI-powered tools that transform complex data into actionable insights.
                                Analyze YouTube videos, extract transcripts, and generate intelligent summaries in seconds.
                            </p>
